...
static const anim_keyframe_t walk_front[] = {{0.0f, -10, -4, 0.2f}, {0.2f, -8, -8, 0.3f}, {0.4f, 4, -4, -0.2f},
                                             {0.6f, 8, 0, 0},       {0.8f, 8, 0, 0},      {1.0f, -10, -4, 0.2f}};
...
static const anim_keyframe_t runr_back[] = {{0.0f, -18, -8, 0.27f}, {0.2f, 0, -8, 0.2f}, {0.4f, 13, -4.5f, -0.05f},
                                            {0.6f, 7, 0, 0},        {0.8f, -6, 0, 0},    {1.0f, -18, -8, 0.27f}};
static const anim_keyframe_t runr_front[] = {{0.0f, 11, -2.5f, -0.05f}, {0.2f, -3, 0, 0},      {0.4f, -18, -8, 0.27f},
                                             {0.6f, -11, -8, 0.3f},     {0.8f, 14, -5, -0.1f}, {1.0f, 11, -2.5f, -0.05f}};
...
static const anim_keyframe_t runl_back[] = {{0.0f, 18, -8, -0.27f},    {0.2f, 6, 0, 0},      {0.4f, -7, 0, 0},
                                            {0.6f, -13, -4.5f, 0.05f}, {0.8f, 0, -8, -0.2f}, {1.0f, 18, -8, -0.27f}};
static const anim_keyframe_t runl_front[] = {{0.0f, -11, -2.5f, 0.05f}, {0.2f, -14, -5, 0.1f}, {0.4f, 11, -8, -0.3f},
                                             {0.6f, 18, -8, -0.27f},    {0.8f, 3, 0, 0},       {1.0f, -11, -2.5f, 0.05f}};
...
/* ---- Ninja Swing ---- */
static const anim_keyframe_t ninja_attach[] = {{0.00f, 0, 0, -0.25f}, {0.10f, 0, 0, -0.05f}, {0.15f, 0, 0, 0.35f},
                                               {0.42f, 0, 0, 0.40f},  {0.50f, 0, 0, 0.35f},  {1.00f, 0, 0, -0.25f}};
